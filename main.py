...
def registrar_mascota():
    ...
    precio = float(input("Precio de atenión de la mascota: "))
...
def registrar_venta(clientes, inventario):
    ...
    while True:
        ...
        if productos:
            ...
            print("No se han registardo productos para la venta")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Opción no válidad. Intente nuevamente.")
